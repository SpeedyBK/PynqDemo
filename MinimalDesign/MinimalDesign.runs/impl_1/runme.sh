...
HD_PWD='/home/benjamin/Repositories/PynqDemo/MinimalDesign/MinimalDesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bidir.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bidir.tcl -notrace
