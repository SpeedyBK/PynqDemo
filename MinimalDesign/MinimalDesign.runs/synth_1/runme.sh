...
HD_PWD='/home/benjamin/Repositories/PynqDemo/MinimalDesign/MinimalDesign.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bidir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bidir.tcl
