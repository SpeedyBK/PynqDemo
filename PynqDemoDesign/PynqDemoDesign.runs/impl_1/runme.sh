...
HD_PWD='/home/benjamin/Repositories/PynqDemo/PynqDemoDesign/PynqDemoDesign.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlMenu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ControlMenu.tcl -notrace
