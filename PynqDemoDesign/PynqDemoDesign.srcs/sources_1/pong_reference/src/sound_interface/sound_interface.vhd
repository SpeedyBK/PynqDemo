...
entity sound_interface is
  port(clock_i        : in std_logic;
       ...
       debug_output   : out std_logic_vector(19 downto 0);
...
--  signal din         : std_logic; -- mmCodec01, einseitig belegt
  ...
  signal audio_sum    : std_logic_vector(7 downto 0);
...
debug_output <= audio_temp;
  ...
  audio_sum <= audio_temp(15 downto 8);
...
PWM_Modulation: entity work.PWM_Modulator
port map (dds_i => audio_sum,
          dds_enable_i => pwm_clk_en,
          clk_i => clock_i,
          reset_i => reset_i,
          PWM_o => pwm_o,
          enable_o => aud_en_o);
