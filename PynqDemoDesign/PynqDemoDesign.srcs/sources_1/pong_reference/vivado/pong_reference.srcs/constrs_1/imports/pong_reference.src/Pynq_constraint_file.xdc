...
## PMODC
set_property -dict { PACKAGE_PIN W8   IOSTANDARD LVCMOS33 } [get_ports { push_button1_i }]; ## [get_ports { pmod_c[0] }];    
set_property -dict { PACKAGE_PIN Y7   IOSTANDARD LVCMOS33 } [get_ports { rot_enc1_i[1]  }]; ## [get_ports { pmod_c[1] }];  
set_property -dict { PACKAGE_PIN Y8   IOSTANDARD LVCMOS33 } [get_ports { rot_enc1_i[0]  }]; ## [get_ports { pmod_c[2] }];  
#set_property -dict { PACKAGE_PIN Y6   IOSTANDARD LVCMOS33 } {  }]; ## [get_ports { pmod_c[3] }];  
set_property -dict { PACKAGE_PIN W9   IOSTANDARD LVCMOS33 } [get_ports { push_button2_i }]; ## [get_ports { pmod_c[4] }];  
set_property -dict { PACKAGE_PIN W6   IOSTANDARD LVCMOS33 } [get_ports { rot_enc2_i[1]  }]; ## [get_ports { pmod_c[5] }];  
set_property -dict { PACKAGE_PIN V10  IOSTANDARD LVCMOS33 } [get_ports { rot_enc2_i[0]  }]; ## [get_ports { pmod_c[6] }];  
